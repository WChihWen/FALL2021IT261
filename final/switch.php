...
<div class="container">
    ...
    <article class="content" style="width:75%">          
            ...
            <div id="divUl">
                <ul >
                    <li><a <?php if($lang == 'Java'){ echo 'class="current"';}?> href="switch.php?lang=Java" >Java</a></li>
                    <li><a <?php if($lang == 'Python'){ echo 'class="current"';}?> href="switch.php?lang=Python" >Python</a></li>     
                    <li><a <?php if($lang == 'PHP'){ echo 'class="current"';}?> href="switch.php?lang=PHP" >PHP</a></li>                  
                </ul>
            </div>
            <div id="divhistory">
                <br>
